...
TEST(Timer, should_invoke_at_most_one_timer_callback_per_run)
{
  given_that_timer_has_been_started(timer_1, 5);
...
TEST(Timer, should_run_multiple_periodic_timers_properly_when_both_are_late)
{
...
TEST(Timer, should_give_the_remaining_ticks_for_a_past_due_timer)
{
  given_that_timer_has_been_started(timer_1, 7);
  given_that_timer_has_been_started(timer_2, 7);
...
TEST(Timer, should_run_several_periodic_timers_with_high_latency)
{
  given_that_periodic_timer_has_been_started(timer_1, 5);

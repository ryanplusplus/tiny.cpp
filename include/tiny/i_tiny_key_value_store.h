...
#define key_value_store_read(self, key, value) \
  (self)->api->read((self), (key), (value))

#define key_value_store_write(self, key, value) \
  (self)->api->write((self), (key), (value))

#define key_value_store_contains(self, key) \
  (self)->api->contains((self), (key))

#define key_value_store_size(self, key) \
  (self)->api->size((self), (key))

#define key_value_store_on_change(self) \

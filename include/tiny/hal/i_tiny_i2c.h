...
#define i2c_write(self, address, prepare_for_restart, buffer, buffer_size) \
  (self)->api->write((self), (address), (prepare_for_restart), (buffer), (buffer_size))

#define i2c_read(self, address, prepare_for_restart, buffer, buffer_size) \
  (self)->api->read((self), (address), (prepare_for_restart), (buffer), (buffer_size))

#define i2c_reset(self) \
  (self)->api->reset((self))
